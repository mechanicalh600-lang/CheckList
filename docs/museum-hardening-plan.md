...
4. Verify login, default-password change, normal navigation, checklist submission, and history reads.
5. Remove public plaintext password material.
6. Replace anonymous/public database policies with museum-session policies.
7. Restrict storage writes to valid museum sessions while preserving public media URLs used by the historical UI.
