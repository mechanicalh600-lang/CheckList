...
-- CheckList uses the Supabase anon publishable key plus its own server-validated
...
grant execute on function public.museum_admin_reset_password(text) to anon;
